...
{
    /**
     * Izveido PDF dokumentu ar vienotām DomPDF opcijām.
     *
     * Šī metode tiek izmantota visiem PDF dokumentiem, lai:
     * - nebūtu jādublē Pdf::loadView kods;
     * - visos PDF dokumentos tiktu izmantots DejaVu Sans fonts;
     * - korekti attēlotos latviešu valodas simboli;
     * - visiem PDF dokumentiem būtu vienots A4 portreta formāts.
     */
    ...
    public function recipeFull(Request $request, Recipe $recipe)
    {
        ...
        $pdf = $this->makePdf('pdf.recipe-full', [
            'recipe' => $recipe,
            'steps' => $steps,
    ...
    public function recipeIngredients(Request $request, Recipe $recipe)
    {
        ...
        $pdf = $this->makePdf('pdf.recipe-ingredients', [
            'recipe' => $recipe,
            'scaledIngredients' => $scaledData['ingredients'],
            'targetServings' => $scaledData['targetServings'],
            'originalServings' => $scaledData['originalServings'],
    ...
    public function recipeSteps(Request $request, Recipe $recipe)
    {
        ...
        $pdf = $this->makePdf('pdf.recipe-steps', compact(
            'recipe',
            'steps',
            'targetServings'
        ));
    ...
    public function categoryRecipes(Category $category)
    {
        ...
        $pdf = $this->makePdf('pdf.category-recipes', compact(
            'category',
            'recipes'
        ));
    ...
    public function userProfile(User $user)
    {
        ...
        $pdf = $this->makePdf('pdf.user-profile', compact(
            'user',
            'recipes'
        ));
    ...
    public function popularRecipes(Request $request)
    {
        ...
        $pdf = $this->makePdf('pdf.popular-recipes', compact(
            'recipes',
            'days',
            'totalViews'
        ));
    ...
    public function adminStatistics()
    {
        ...
        $pdf = $this->makePdf('pdf.admin-statistics', compact(
            'usersCount',
            'recipesCount',
            'commentsCount',
            'averageRating',
    ...
    public function filteredRecipes(Request $request)
    {
        ...
        $pdf = $this->makePdf('pdf.filtered-recipes', compact(
            'recipes',
            'filters'
        ));
